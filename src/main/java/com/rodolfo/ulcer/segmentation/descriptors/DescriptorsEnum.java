...
public enum DescriptorsEnum {
    ...
    color_bgr_b_intensity_1,
    color_bgr_g_intensity_1,
    color_bgr_r_intensity_1,
    color_bgr_b_intensity_2,
    color_bgr_g_intensity_2,
    color_bgr_r_intensity_2,
    color_bgr_b_frequency_1,
    color_bgr_g_frequency_1,
    color_bgr_r_frequency_1,
    color_bgr_b_frequency_2,
    color_bgr_g_frequency_2,
    color_bgr_r_frequency_2,
    // COR LAB
    color_lab_l_mean,
    color_lab_a_mean,
    color_lab_b_mean,
    ...
    color_lab_l_intensity_1,
    color_lab_a_intensity_1,
    color_lab_b_intensity_1,
    color_lab_l_intensity_2,
    color_lab_a_intensity_2,
    color_lab_b_intensity_2,
    color_lab_l_frequency_1,
    color_lab_a_frequency_1,
    color_lab_b_frequency_1,
    color_lab_l_frequency_2,
    color_lab_a_frequency_2,
    color_lab_b_frequency_2,
    // COR LUV
    color_luv_l_mean,
    color_luv_u_mean,
    color_luv_v_mean,
    ...
    color_luv_l_intensity_1,
    color_luv_u_intensity_1,
    color_luv_v_intensity_1,
    color_luv_l_intensity_2,
    color_luv_u_intensity_2,
    color_luv_v_intensity_2,
    color_luv_l_frequency_1,
    color_luv_u_frequency_1,
    color_luv_v_frequency_1,
    color_luv_l_frequency_2,
    color_luv_u_frequency_2,
    color_luv_v_frequency_2,
    // COR NORM
    color_norm_b_mean,
    color_norm_g_mean,
    color_norm_r_mean,
    ...
    color_norm_b_intensity_1,
    color_norm_g_intensity_1,
    color_norm_r_intensity_1,
    color_norm_b_intensity_2,
    color_norm_g_intensity_2,
    color_norm_r_intensity_2,
    color_norm_b_frequency_1,
    color_norm_g_frequency_1,
    color_norm_r_frequency_1,
    color_norm_b_frequency_2,
    color_norm_g_frequency_2,
    color_norm_r_frequency_2,
